...
Este repositorio agrupa los **trabajos** de la asignatura **Aprendizaje de Máquina** del programa de Maestría en Inteligencia Artificial.
...
```bash
cd machine_learning/clasificador_mnist
make up
```
